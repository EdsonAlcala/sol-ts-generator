...
var generate = function (options) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, globPromise(options.glob)];
            case 1:
                files = _a.sent();
                files.forEach(function (file) {
                    var filePath = path_1.default.join("..", file); // TO change
                    var definition = require(filePath);
                    console.log(buildContract_1.buildContract(definition));
                    buildContract_1.buildContract(definition);
                });
                return [2 /*return*/];
        }
    });
